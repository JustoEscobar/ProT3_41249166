<!-- Inicio Formulario Alta Usuario -->
            ...
            <div class="row align-items-center justify-content-center h-100 g-0 px-4 px-sm-0">
                <div class="col col-sm-6 col-lg-7 col-xl-6">
                    ...
                    <div class="text-center mb-5">
                        ...
                        <p class="text-secondary">Dar de alta una cuenta en Coffe House</p>
                    </div>
                    <?php $validation = \Config\Services::validation(); ?>
                    <form method="post" action="<?php echo base_url('/enviar-form-alta'); ?>">
                        <?= csrf_field(); ?>
                        <?= csrf_field(); ?>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input name="perfil_id" type="text" class="form-control form-control-lg fs-6" placeholder="1-Admin 2-Cliente" />
                            <!--Error-->
                        ...
                        <div class="d-flex justify-content-between">
                            <input type="submit" value="Registrar" class="btn boton-registro btn-dark btn-lg w-48 mb-3" />
